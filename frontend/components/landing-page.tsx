  ...
  return (
    <>
      ...
      <main className="min-h-screen overflow-hidden bg-[#050505] text-white">
        ...
        <section className="relative z-10 overflow-hidden border-y border-white/10 py-6">

          <div className="marquee-track flex w-max">

            <div className="flex whitespace-nowrap font-mono text-xs text-gray-400 md:text-sm">
        ...
        <section
          id="problem"
          className="relative z-10 border-b border-white/10 px-6 py-32 md:px-12 lg:px-20"
        >
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-12 grid gap-16 lg:grid-cols-2">
              ...
              <div className="flex flex-col justify-end">
                ...
                <p className="mt-8 max-w-xl font-mono text-xs leading-6 text-gray-400">
            ...
            <div className="mt-24 grid grid-cols-2 gap-3 md:grid-cols-4">
              ...
              {[
                ...
                >
                  ...
                  <div className="mt-4 font-mono text-[9px] text-gray-400">
                    UNCONNECTED
                  </div>
        ...
        >
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <p className="mt-16 max-w-2xl text-sm leading-7 text-gray-400">
            ...
            <div className="mt-24">
              ...
              {[
                ...
                >
                  ...
                  <div className="max-w-2xl text-sm leading-7 text-gray-400">
                    {description}
                  </div>
        ...
        <section className="relative z-10 border-b border-white/10 px-6 py-32 md:px-12 lg:px-20">
            ...
            <div className="mt-24 grid gap-3 md:grid-cols-2">
              ...
              {[
                ...
                >
                  ...
                  <div className="mt-10 font-mono text-[9px] text-gray-400 transition group-hover:text-[#7cff6b]">
                    ACCESS MODULE →
                  </div>
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-12 grid gap-16 lg:grid-cols-2">
              ...
              <div>
                ...
                <p className="mt-10 max-w-lg text-gray-400 leading-7">
              ...
              <div className="alert-box scan-box border border-red-500/30 bg-red-500/[0.02] p-8">
                ...
                <div className="mt-8 font-mono text-[9px] text-gray-400">
        ...
        <section className="relative z-10 border-b border-white/10 px-6 py-32 md:px-12 lg:px-20">
          ...
          <div className="mx-auto max-w-7xl">
                ...
                {[
                  ...
                  >
                    ...
                    <div className="hash-node w-48 border border-white/10 bg-[#050505] p-6">
                      ...
                      <div className="mt-6 truncate font-mono text-[8px] text-gray-400">
                        SHA256 / 8A3F91D2...
                      </div>


                      <div className="mt-3 font-mono text-[8px] text-gray-400">
                        ✓ VERIFIED
                      </div>
            ...
            <p className="mt-10 max-w-2xl font-mono text-xs leading-6 text-gray-400">
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-12 grid gap-16 lg:grid-cols-2">
              ...
              <div>
                ...
                <p className="mt-10 max-w-lg leading-7 text-gray-400">
        ...
        <section className="relative z-10 relative overflow-hidden border-b border-white/10 px-6 py-40 md:px-12 lg:px-20">
          ...
          <div className="relative mx-auto max-w-7xl text-center">
            ...
            <h2 className="mt-8 text-6xl font-black uppercase leading-[0.8] tracking-tight text-gray-400 md:text-[10vw]">
            ...
            <p className="mx-auto mt-14 max-w-2xl text-sm leading-7 text-gray-400">
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="scan-box border border-white/10 p-10 md:p-20">
              ...
              <div className="mt-12 flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
                ...
                <p className="max-w-xl font-mono text-xs leading-6 text-gray-400">
                  CONNECT EVIDENCE.
                  FIND CONTRADICTIONS.
        ...
        <footer className="border-t border-white/10 px-6 py-10 md:px-12 lg:px-20">
          ...
          <div className="mx-auto flex max-w-7xl flex-col justify-between gap-5 font-mono text-[9px] text-gray-400 md:flex-row">
